...
def app():
    cs_sidebar(logo_img="./resources/logomark_website.png")
    cs_body()
...
# sidebar
def cs_sidebar(logo_img="logomark_website.png"):

    st.sidebar.markdown('''[<img src='data:image/png;base64,{}' class='img-fluid' width=32 height=32>](https://streamlit.io/)'''.format(img_to_bytes(logo_img)), unsafe_allow_html=True)
